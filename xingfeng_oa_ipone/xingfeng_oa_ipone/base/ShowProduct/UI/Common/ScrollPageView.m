...
-(void)setContentOfTables:(NSInteger)aNumerOfTables{
    ...
    */
    ...
    for (int i = 0; i < [conts count]; i++) {
        id obj=[conts objectAtIndex:i];
        [[obj view] setFrame:CGRectMake(320 * i, 0, 320, self.frame.size.height)];
        [_scrollView addSubview:[obj view]];
        [_contentItems addObject:[obj view]];
    }
    [_scrollView setContentSize:CGSizeMake(320 * aNumerOfTables, self.frame.size.height)];
}
...
-(void)freshContentTableAtIndex:(NSInteger)aIndex{
    ...
    //id obj=[conts objectAtIndex:aIndex];
    //[obj setBackgroundColor:[UIColor brownColor]];
